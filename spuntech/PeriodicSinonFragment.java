...
public class PeriodicSinonFragment extends Fragment {

    private PeriodicSinonViewModel mViewModel;
    ...
    private Button sinonButton;
    public static PeriodicSinonFragment newInstance() {
        return new PeriodicSinonFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        final View root = inflater.inflate(R.layout.sort_by_periodic_fault_fragment, container, false);
        ...
        sinonButton = root.findViewById(R.id.sortByPeriodicFloatingIcon);
        //unitSpinner
         spinner1 = (Spinner) root.findViewById(R.id.sortByPeriodicUnit);
...
// Apply the adapter to the spinner
        ...
        //subUnitSpinner
         spinner2 = (Spinner) root.findViewById(R.id.sortByPeriodicSubUnit);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        //faultypeSpinner
         spinner3 = (Spinner) root.findViewById(R.id.sortByPeriodicFaultType);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        //treatTypeSpinner
         spinner4 = (Spinner) root.findViewById(R.id.sortByPeriodicTreatType);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        //handlerSpinner
        spinner5 = (Spinner) root.findViewById(R.id.sortByPeriodicHandler);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        //statusSpinner
         spinner6 = (Spinner) root.findViewById(R.id.sortByPeriodicStatus);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        //notify Period Spinner
         spinner7 = (Spinner) root.findViewById(R.id.sortByPeriodicPeriod);
// Create an ArrayAdapter using the string array and a default spinner layout
...
// Apply the adapter to the spinner
        ...
        spinner7.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               TextView tv=(TextView)parent.getChildAt(0);
                tv.setTextColor(getResources().getColor(R.color.colorBlue));
                Global.setNotify(spinner7.getSelectedItem().toString());
                Global.setCanSort(true);
    ...
    public void onViewCreated(View view,Bundle savedInstanceState)
    {
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true /* enabled by default */) {
            ...
            public void handleOnBackPressed() {
                navController.navigate(R.id.action_periodicSinonFragment_to_nav_allperioicfaults);
            }
        };
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(PeriodicSinonViewModel.class);
